...
})()(
  {
        ...
        module.exports = function (version) {
          Object.keys(instructions).forEach(function (code) {
            if (!instructions[code][version]) {
              throw (
                'invalid version ' + version + ': ' + code + ' not supported'
              );
            }
          });
          ...
          return {
            capitalizeFirstLetter: function (language, string) {
              return (
                string.charAt(0).toLocaleUpperCase(language) + string.slice(1)
              );
            },
            ordinalize: function (language, number) {
              ...
              return (
                instructions[language][version].constants.ordinalize[
                  number.toString()
                ] || ''
              );
            },
            ...
            getWayName: function (language, step, options) {
              ...
              if (name && ref && name !== ref && !wayMotorway) {
                ...
                wayName =
                  options && options.formatToken
                    ? options.formatToken('ref', ref)
                    : ref;
              } else if (!name && ref) {
                wayName =
                  options && options.formatToken
            ...
            compile: function (language, step, opts) {
              ...
              if (instructions[language][version].modes[mode]) {
                ...
                var omitSide =
                  type === 'off ramp' && modifier.indexOf(side) >= 0;
                if (
                  instructions[language][version][type][modifier] &&
                  !omitSide
                ) {
                  instructionObject =
                    instructions[language][version][type][modifier];
                  ...
                  instructionObject =
                    instructions[language][version][type].default;
                }
              }
              ...
              var destinations =
                step.destinations && step.destinations.split(': ');
              var destinationRef =
                destinations && destinations[0].split(',')[0];
              var destination =
                destinations &&
                destinations[1] &&
                destinations[1].split(',')[0];
              ...
              var replaceTokens = {
                ...
                modifier:
                  instructions[language][version].constants.modifier[modifier],
            ...
            tokenize: function (language, instruction, tokens, options) {
              ...
              var output = instruction
                .replace(/\{(\w+)(?::(\w+))?\}/g, function (
                  ...
                  if (
                    offset === 0 &&
                    instructions[language].meta.capitalizeFirstLetter
                  ) {
    ...
    4: [
      function (_dereq_, module, exports) {
        ...
        var instructionsZhHans = _dereq_(
        ...
        module.exports = {
          ...
          v5: {
            accusative: [
              ...
              [
                '^ (\\S+)ая (\\S+)ая ([Аа]вто)?[Дд]орога ',
                ' $1ую $2ую $3дорогу ',
              ],
              [
                '^ (\\d+)-я (\\S+)ая ([Аа]вто)?[Дд]орога ',
                ' $1-ю $2ую $3дорогу ',
              ],
            ...
            dative: [
              ...
              [
                '^ (\\S+)[иоы]й (\\S+н)ий [Бб]ульвар ',
                ' $1ому $2ему бульвару ',
              ],
              [
                '^ (\\S+н)ий (\\S+)[иоы]й [Бб]ульвар ',
                ' $1ему $2ому бульвару ',
              ],
              [
                '^ (\\S+)[иоы]й (\\S+)[иоы]й [Бб]ульвар ',
                ' $1ому $2ому бульвару ',
              ],
              [
                '^ (\\S+)[иоы]й (\\S+[иы]н) [Бб]ульвар ',
                ' $1ому $2у бульвару ',
              ],
              ...
              [
                '^ (\\S+)[иоы]й-(\\S+)[иоы]й [Пп]ереулок ',
                ' $1ому-$2ому переулку ',
              ],
              [
                '^ (\\d+)-й (\\S+)[иоы]й-(\\S+)[иоы]й [Пп]ереулок ',
                ' $1-му $2ому-$3ому переулку ',
              ],
              ...
              [
                '^ (\\S+)[иоы]й (\\S+[еёо]в) [Пп]ереулок ',
                ' $1ому $2у переулку ',
              ],
              [
                '^ (\\S+)[иоы]й (\\S+[иы]н) [Пп]ереулок ',
                ' $1ому $2у переулку ',
              ],
              ...
              [
                '^ (\\d+)-й (\\S+н)ий (\\S+)[иоы]й [Пп]роезд ',
                ' $1-му $2ему $3ому проезду ',
              ],
              [
                '^ (\\d+)-й (\\S+)[иоы]й (\\S+)[иоы]й [Пп]роезд ',
                ' $1-му $2ому $3ому проезду ',
              ],
              ['^ [Пп]роезд ', ' проезду '],
              ...
              [
                '^ (\\S+)[иоы]й (\\S+н)ий [Пп]роспект ',
                ' $1ому $2ему проспекту ',
              ],
              [
                '^ (\\S+н)ий (\\S+)[иоы]й [Пп]роспект ',
                ' $1ему $2ому проспекту ',
              ],
              [
                '^ (\\S+)[иоы]й (\\S+)[иоы]й [Пп]роспект ',
                ' $1ому $2ому проспекту ',
              ],
              [
                '^ (\\S+)[иоы]й (\\S+[иы]н) [Пп]роспект ',
                ' $1ому $2у проспекту ',
              ],
              ['^ (\\d+)-й (\\S+н)ий [Пп]роспект ', ' $1-му $2ему проспекту '],
              [
                '^ (\\d+)-й (\\S+)[иоы]й [Пп]роспект ',
                ' $1-му $2ому проспекту ',
              ],
              ...
              [
                '^ (\\S+)[иоы]й (\\S+н)ий [Пп]утепровод ',
                ' $1ому $2ему путепроводу ',
              ],
              [
                '^ (\\S+н)ий (\\S+)[иоы]й [Пп]утепровод ',
                ' $1ему $2ому путепроводу ',
              ],
              [
                '^ (\\S+)[иоы]й (\\S+)[иоы]й [Пп]утепровод ',
                ' $1ому $2ому путепроводу ',
              ],
              [
                '^ (\\S+)[иоы]й (\\S+[иы]н) [Пп]утепровод ',
                ' $1ому $2у путепроводу ',
              ],
              [
                '^ (\\d+)-й (\\S+н)ий [Пп]утепровод ',
                ' $1-му $2ему путепроводу ',
              ],
              [
                '^ (\\d+)-й (\\S+)[иоы]й [Пп]утепровод ',
                ' $1-му $2ому путепроводу ',
              ],
              [
                '^ (\\d+)-й (\\S+[иы]н) [Пп]утепровод ',
                ' $1-му $2у путепроводу ',
              ],
              ...
              [
                '^ (\\S+)[иоы]й (\\S+н)ий [Тт][уо]ннель ',
                ' $1ому $2ему тоннелю ',
              ],
              [
                '^ (\\S+н)ий (\\S+)[иоы]й [Тт][уо]ннель ',
                ' $1ему $2ому тоннелю ',
              ],
              [
                '^ (\\S+)[иоы]й (\\S+)[иоы]й [Тт][уо]ннель ',
                ' $1ому $2ому тоннелю ',
              ],
              [
                '^ (\\S+)[иоы]й (\\S+[иы]н) [Тт][уо]ннель ',
                ' $1ому $2у тоннелю ',
              ],
              ['^ (\\d+)-й (\\S+н)ий [Тт][уо]ннель ', ' $1-му $2ему тоннелю '],
              [
                '^ (\\d+)-й (\\S+)[иоы]й [Тт][уо]ннель ',
                ' $1-му $2ому тоннелю ',
              ],
              ...
              [
                '^ (\\S+[ео])е (\\S+[ео])е ([Пп]олу)?[Кк]ольцо ',
                ' $1му $2му $3кольцу ',
              ],
              [
                '^ (\\S+ье) (\\S+[ео])е ([Пп]олу)?[Кк]ольцо ',
                ' $1му $2му $3кольцу ',
              ],
              [
                '^ (\\d+)-е (\\S+[ео])е ([Пп]олу)?[Кк]ольцо ',
                ' $1-му $2му $3кольцу ',
              ],
              [
                '^ (\\d+)-е (\\S+ье) ([Пп]олу)?[Кк]ольцо ',
                ' $1-му $2му $3кольцу ',
              ],
            ...
            genitive: [
              ...
              [
                '^ (\\d+)-й (\\S+н)ий (\\S+)[иоы]й [Пп]роезд ',
                ' $1-го $2его $3ого проезда ',
              ],
              [
                '^ (\\d+)-й (\\S+)[иоы]й (\\S+)[иоы]й [Пп]роезд ',
                ' $1-го $2ого $3ого проезда ',
              ],
              ['^ [Пп]роезд ', ' проезда '],
              ...
              [
                '^ (\\S+)[иоы]й (\\S+н)ий [Пп]утепровод ',
                ' $1ого $2его путепровода ',
              ],
              [
                '^ (\\S+н)ий (\\S+)[иоы]й [Пп]утепровод ',
                ' $1его $2ого путепровода ',
              ],
              [
                '^ (\\S+)[иоы]й (\\S+)[иоы]й [Пп]утепровод ',
                ' $1ого $2ого путепровода ',
              ],
              [
                '^ (\\S+)[иоы]й (\\S+[иы]н) [Пп]утепровод ',
                ' $1ого $2ого путепровода ',
              ...
              [
                '^ (\\d+)-й (\\S+н)ий [Пп]утепровод ',
                ' $1-го $2его путепровода ',
              ],
              [
                '^ (\\d+)-й (\\S+)[иоы]й [Пп]утепровод ',
                ' $1-го $2ого путепровода ',
              ],
              [
                '^ (\\d+)-й (\\S+[иы]н) [Пп]утепровод ',
                ' $1-го $2ого путепровода ',
          ...
          v5: {
            ...
            phrase: {
              'two linked by distance':
                '{instruction_one} derefter, efter {distance}, {instruction_two}',
            ...
            arrive: {
              ...
              left: {
                default:
                  'Du er ankommet til din {nth} destination, som befinder sig til venstre',
                upcoming:
                  'Du vil ankomme til din {nth} destination på venstre hånd',
                short: 'Du er ankommet',
                'short-upcoming': 'Du vil ankomme',
                named:
                  'Du er ankommet til {waypoint_name}, som befinder sig til venstre',
              },
              right: {
                default:
                  'Du er ankommet til din {nth} destination, som befinder sig til højre',
                upcoming:
                  'Du vil ankomme til din {nth} destination på højre hånd',
                short: 'Du er ankommet',
                'short-upcoming': 'Du vil ankomme',
                named:
                  'Du er ankommet til {waypoint_name}, som befinder sig til højre',
              },
              'sharp left': {
                default:
                  'Du er ankommet til din {nth} destination, som befinder sig til venstre',
              ...
              straight: {
                default:
                  'Du er ankommet til din {nth} destination, der befinder sig lige frem',
                upcoming: 'Du vil ankomme til din {nth} destination foran dig',
                short: 'Du er ankommet',
                'short-upcoming': 'Du vil ankomme',
                named:
                  'Du er ankommet til {waypoint_name}, der befinder sig lige frem',
              },
            },
            continue: {
              default: {
            ...
            'end of road': {
              ...
              uturn: {
                ...
                destination:
                  'Foretag en U-vending mod {destination} for enden af vejen',
              },
            },
            fork: {
              default: {
            ...
            'off ramp': {
              ...
              left: {
                ...
                exit_destination:
                  'Vælg afkørsel {exit} til venstre mod {destination}\n',
              },
              right: {
                ...
                exit_destination:
                  'Vælg afkørsel {exit} til højre mod {destination}',
              },
              'sharp left': {
                default: 'Tag afkørslen til venstre',
                name: 'Tag afkørslen til venstre ad {way_name}',
            ...
            rotary: {
              default: {
                ...
                name: {
                  ...
                  destination:
                    'Kør ind i {rotary_name} og kør mod {destination}',
                },
                exit: {
                  default:
                    'Tag rundkørslen og forlad ved {exit_number} afkørsel',
                  name:
                    'Tag rundkørslen og forlad ved {exit_number} afkørsel ad {way_name}',
                  destination:
                    'Tag rundkørslen og forlad ved {exit_number} afkørsel mod {destination}',
                },
                name_exit: {
                  default:
                    'Kør ind i {rotary_name} og forlad ved {exit_number} afkørsel',
                  name:
                    'Kør ind i {rotary_name} og forlad ved {exit_number} afkørsel ad {way_name}',
                  destination:
                    'Kør ind i {rotary_name} og forlad ved {exit_number} afkørsel mod {destination}',
                },
              },
            },
            roundabout: {
      ...
      function (_dereq_, module, exports) {
        module.exports = {
          ...
          v5: {
            ...
            phrase: {
              'two linked by distance':
                '{instruction_one} danach in {distance} {instruction_two}',
            ...
            arrive: {
              ...
              straight: {
                ...
                'short-upcoming': 'Sie haben Ihr {nth} Ziel erreicht',
                named:
                  'Sie haben Ihr {waypoint_name}, es befindet sich geradeaus',
              },
            },
            continue: {
              default: {
              ...
              straight: {
                ...
                namedistance:
                  'Geradeaus weiterfahren auf {way_name} für {distance}',
              },
              'sharp left': {
            ...
            depart: {
              default: {
                ...
                namedistance:
                  'Fahren Sie Richtung {direction} auf {way_name} für {distance}',
              },
            },
            'end of road': {
              default: {
              ...
              uturn: {
                ...
                destination:
                  '180°-Wendung Richtung {destination} am Ende der Straße',
              },
            },
            fork: {
              default: {
                ...
                destination:
                  '{modifier}  halten an der Gabelung Richtung {destination}',
              },
              'slight left': {
                default: 'Links halten an der Gabelung',
                name: 'Links halten an der Gabelung auf {way_name}',
                destination:
                  'Links halten an der Gabelung Richtung {destination}',
              },
              'slight right': {
                default: 'Rechts halten an der Gabelung',
                name: 'Rechts halten an der Gabelung auf {way_name}',
                destination:
                  'Rechts halten an der Gabelung Richtung {destination}',
              },
              'sharp left': {
            ...
            'off ramp': {
              default: {
                ...
                exit_destination:
                  'Ausfahrt {exit} nehmen Richtung {destination}',
              },
              left: {
                ...
                exit_destination:
                  'Ausfahrt {exit} links nehmen Richtung {destination}',
              },
              right: {
            ...
            rotary: {
              default: {
                default: {
                  ...
                  destination:
                    'Im Kreisverkehr die Ausfahrt Richtung {destination} nehmen',
                },
                name: {
                  default: 'In {rotary_name} fahren',
                  name: 'In {rotary_name} die Ausfahrt auf {way_name} nehmen',
                  destination:
                    'In {rotary_name} die Ausfahrt Richtung {destination} nehmen',
                },
                exit: {
                  default: 'Im Kreisverkehr die {exit_number} Ausfahrt nehmen',
                  name:
                    'Im Kreisverkehr die {exit_number} Ausfahrt nehmen auf {way_name}',
                  destination:
                    'Im Kreisverkehr die {exit_number} Ausfahrt nehmen Richtung {destination}',
                },
                name_exit: {
                  default:
                    'In den Kreisverkehr fahren und {exit_number} Ausfahrt nehmen',
                  name:
                    'In den Kreisverkehr fahren und {exit_number} Ausfahrt nehmen auf {way_name}',
                  destination:
                    'In den Kreisverkehr fahren und {exit_number} Ausfahrt nehmen Richtung {destination}',
                },
              },
            },
            roundabout: {
          ...
          v5: {
            ...
            arrive: {
              ...
              left: {
                ...
                upcoming:
                  'You will arrive at your {nth} destination, on the left',
                short: 'You have arrived',
                'short-upcoming': 'You will arrive',
              ...
              right: {
                ...
                upcoming:
                  'You will arrive at your {nth} destination, on the right',
                short: 'You have arrived',
                'short-upcoming': 'You will arrive',
              ...
              straight: {
                ...
                upcoming:
                  'You will arrive at your {nth} destination, straight ahead',
                short: 'You have arrived',
                'short-upcoming': 'You will arrive',
            ...
            rotary: {
              default: {
                default: {
                  ...
                  destination:
                    'Enter the traffic circle and exit towards {destination}',
                },
                name: {
                  default: 'Enter {rotary_name}',
                  name: 'Enter {rotary_name} and exit onto {way_name}',
                  destination:
                    'Enter {rotary_name} and exit towards {destination}',
                },
                exit: {
                  default:
                    'Enter the traffic circle and take the {exit_number} exit',
                  name:
                    'Enter the traffic circle and take the {exit_number} exit onto {way_name}',
                  destination:
                    'Enter the traffic circle and take the {exit_number} exit towards {destination}',
                },
                name_exit: {
                  default:
      ...
      function (_dereq_, module, exports) {
        module.exports = {
          ...
          v5: {
            ...
            phrase: {
              'two linked by distance':
                '{instruction_one} kaj post {distance} {instruction_two}',
            ...
            depart: {
              default: {
                ...
                namedistance:
                  'Direktiĝu {direction} al {way_name} tra {distance}',
              },
            },
            'end of road': {
              default: {
              ...
              uturn: {
                ...
                destination:
                  'Turniĝu malantaŭen direkte al {destination} ĉe fino de la vojo',
              },
            },
            fork: {
              default: {
            ...
            rotary: {
              default: {
                default: {
                  ...
                  destination:
                    'Enveturu trafikcirklegon kaj elveturu direkte al {destination}',
                },
                name: {
                  default: 'Enveturu {rotary_name}',
                  name: 'Enveturu {rotary_name} kaj elveturu al {way_name}',
                  destination:
                    'Enveturu {rotary_name} kaj elveturu direkte al {destination}',
                },
                exit: {
                  default:
                    'Enveturu trafikcirklegon kaj sekve al {exit_number} elveturejo',
                  name:
                    'Enveturu trafikcirklegon kaj sekve al {exit_number} elveturejo al {way_name}',
                  destination:
                    'Enveturu trafikcirklegon kaj sekve al {exit_number} elveturejo direkte al {destination}',
                },
                name_exit: {
                  default:
                    'Enveturu {rotary_name} kaj sekve al {exit_number} elveturejo',
                  name:
                    'Enveturu {rotary_name} kaj sekve al {exit_number} elveturejo al {way_name}',
                  destination:
                    'Enveturu {rotary_name} kaj sekve al {exit_number} elveturejo direkte al {destination}',
                },
              },
            },
            roundabout: {
            ...
            'exit roundabout': {
              default: {
                ...
                destination:
                  'Elveturu trafikcirklegon direkte al {destination}',
              },
            },
            'exit rotary': {
              default: {
      ...
      function (_dereq_, module, exports) {
        module.exports = {
          ...
          v5: {
            ...
            phrase: {
              'two linked by distance':
                '{instruction_one} y luego en {distance}, {instruction_two}',
            ...
            depart: {
              default: {
                ...
                namedistance:
                  'Dirígete al {direction} en {way_name} por {distance}',
              },
            },
            'end of road': {
              default: {
                ...
                destination:
                  'Al final de la calle gira {modifier} hacia {destination}',
              },
              straight: {
                default: 'Al final de la calle continúa recto',
                name: 'Al final de la calle continúa recto por {way_name}',
                destination:
                  'Al final de la calle continúa recto hacia {destination}',
              },
              uturn: {
                default: 'Al final de la calle haz un cambio de sentido',
                name:
                  'Al final de la calle haz un cambio de sentido en {way_name}',
                destination:
                  'Al final de la calle haz un cambio de sentido hacia {destination}',
              },
            },
            fork: {
              default: {
            ...
            'new name': {
              ...
              'slight left': {
                ...
                destination:
                  'Continúa ligeramente por la izquierda hacia {destination}',
              },
              'slight right': {
                default: 'Continúa ligeramente por la derecha',
                name: 'Continúa ligeramente por la derecha por {way_name}',
                destination:
                  'Continúa ligeramente por la derecha hacia {destination}',
              },
              uturn: {
                default: 'Haz un cambio de sentido',
                name: 'Haz un cambio de sentido en {way_name}',
            ...
            'off ramp': {
              default: {
                ...
                exit_destination:
                  'Coge la cuesta abajo {exit} hacia {destination}',
              },
              left: {
                default: 'Coge la cuesta abajo de la izquierda',
                name: 'Coge la cuesta abajo de la izquierda por {way_name}',
                destination:
                  'Coge la cuesta abajo de la izquierda hacia {destination}',
                exit: 'Coge la cuesta abajo {exit} a tu izquierda',
                exit_destination:
                  'Coge la cuesta abajo {exit} a tu izquierda hacia {destination}',
              },
              right: {
                default: 'Coge la cuesta abajo de la derecha',
                name: 'Coge la cuesta abajo de la derecha por {way_name}',
                destination:
                  'Coge la cuesta abajo de la derecha hacia {destination}',
                exit: 'Coge la cuesta abajo {exit}',
                exit_destination:
                  'Coge la cuesta abajo {exit} hacia {destination}',
              },
            ...
            'on ramp': {
              ...
              left: {
                ...
                destination:
                  'Coge la cuesta de la izquierda hacia {destination}',
              },
              right: {
            ...
            rotary: {
              default: {
                ...
                exit: {
                  ...
                  name:
                    'En la rotonda toma la {exit_number} salida por {way_name}',
                  destination:
                    'En la rotonda toma la {exit_number} salida hacia {destination}',
                },
                name_exit: {
                  default: 'En {rotary_name} toma la {exit_number} salida',
                  name:
                    'En {rotary_name} toma la {exit_number} salida por {way_name}',
                  destination:
                    'En {rotary_name} toma la {exit_number} salida hacia {destination}',
                },
              },
            },
            roundabout: {
              default: {
                ...
                default: {
                  ...
                  destination:
                    'Incorpórate en la rotonda y sal hacia {destination}',
                },
              },
            },
            'roundabout turn': {
      ...
      function (_dereq_, module, exports) {
        module.exports = {
          ...
          v5: {
            ...
            phrase: {
              'two linked by distance':
                '{instruction_one} y luego a {distance}, {instruction_two}',
              'two linked': '{instruction_one} y luego {instruction_two}',
              'one in distance': 'A {distance}, {instruction_one}',
              'name and ref': '{name} ({ref})',
              'exit with number': 'salida {exit}',
            ...
            'end of road': {
              ...
              uturn: {
                ...
                name:
                  'Haz un cambio de sentido en {way_name} al final de la via',
                destination:
                  'Haz un cambio de sentido hacia {destination} al final de la via',
              },
            },
            fork: {
              default: {
            ...
            'new name': {
              ...
              'slight left': {
                ...
                destination:
                  'Continúa levemente a la izquierda hacia {destination}',
              },
              'slight right': {
                default: 'Continúa levemente a la derecha',
                name: 'Continúa levemente a la derecha en {way_name}',
                destination:
                  'Continúa levemente a la derecha hacia {destination}',
              },
              uturn: {
                default: 'Haz un cambio de sentido',
                name: 'Haz un cambio de sentido en {way_name}',
            ...
            'off ramp': {
              ...
              left: {
                ...
                exit_destination:
                  'Toma la salida {exit} en la izquierda hacia {destination}',
              },
              right: {
                ...
                exit_destination:
                  'Toma la salida {exit} en la derecha hacia {destination}',
              },
              'sharp left': {
                default: 'Ve cuesta abajo en la izquierda',
                name: 'Ve cuesta abajo en la izquierda en {way_name}',
                destination:
                  'Ve cuesta abajo en la izquierda hacia {destination}',
                exit: 'Toma la salida {exit} en la izquierda',
                exit_destination:
                  'Toma la salida {exit} en la izquierda hacia {destination}',
              },
              'sharp right': {
                ...
                destination:
                  'Ve cuesta abajo en la derecha hacia {destination}',
                exit: 'Toma la salida {exit} en la derecha',
                exit_destination:
                  'Toma la salida {exit} en la derecha hacia {destination}',
              },
            ...
            'on ramp': {
              ...
              left: {
                ...
                destination:
                  'Toma la rampa en la izquierda hacia {destination}',
              },
              right: {
            ...
            rotary: {
              default: {
                ...
                name: {
                  ...
                  destination:
                    'Entra en {rotary_name} y sal hacia {destination}',
                },
                exit: {
                  default: 'Entra en la rotonda y toma la {exit_number} salida',
                  name:
                    'Entra en la rotonda y toma la {exit_number} salida a {way_name}',
                  destination:
                    'Entra en la rotonda y toma la {exit_number} salida hacia {destination}',
                },
                name_exit: {
                  default:
                    'Entra en {rotary_name} y coge la {exit_number} salida',
                  name:
                    'Entra en {rotary_name} y coge la {exit_number} salida en {way_name}',
                  destination:
                    'Entra en {rotary_name} y coge la {exit_number} salida hacia {destination}',
                },
              },
            },
            roundabout: {
      ...
      function (_dereq_, module, exports) {
        module.exports = {
          ...
          v5: {
            ...
            phrase: {
              'two linked by distance':
                '{instruction_one}, sitten {distance} päästä, {instruction_two}',
            ...
            arrive: {
              ...
              left: {
                default:
                  'Olet saapunut {nth} määränpäähäsi, joka on vasemmalla puolellasi',
                upcoming:
                  'Saavut {nth} määränpäähäsi, joka on vasemmalla puolellasi',
                short: 'Olet saapunut',
                'short-upcoming': 'Saavut',
                named:
                  'Olet saapunut määränpäähän {waypoint_name}, joka on vasemmalla puolellasi',
              },
              right: {
                default:
                  'Olet saapunut {nth} määränpäähäsi, joka on oikealla puolellasi',
                upcoming:
                  'Saavut {nth} määränpäähäsi, joka on oikealla puolellasi',
                short: 'Olet saapunut',
                'short-upcoming': 'Saavut',
                named:
                  'Olet saapunut määränpäähän {waypoint_name}, joka on oikealla puolellasi',
              },
              'sharp left': {
                default:
                  'Olet saapunut {nth} määränpäähäsi, joka on vasemmalla puolellasi',
              ...
              straight: {
                default:
                  'Olet saapunut {nth} määränpäähäsi, joka on suoraan edessäsi',
                upcoming: 'Saavut {nth} määränpäähäsi, suoraan edessä',
                short: 'Olet saapunut',
                'short-upcoming': 'Saavut',
                named:
                  'Olet saapunut määränpäähän {waypoint_name}, joka on suoraan edessäsi',
              },
            },
            continue: {
              default: {
            ...
            fork: {
              ...
              'sharp left': {
                ...
                name:
                  'Käänny tienhaarassa jyrkästi vasempaan tielle {way_name}',
                destination:
                  'Käänny tienhaarassa jyrkästi vasempaan suuntana {destination}',
              },
              'sharp right': {
                default: 'Käänny tienhaarassa jyrkästi oikeaan',
                name: 'Käänny tienhaarassa jyrkästi oikeaan tielle {way_name}',
                destination:
                  'Käänny tienhaarassa jyrkästi oikeaan suuntana {destination}',
              },
              uturn: {
                default: 'Tee U-käännös',
            ...
            'off ramp': {
              default: {
                ...
                exit_destination:
                  'Ota poistuminen {exit}, suuntana {destination}',
              },
              left: {
                default: 'Aja vasemmalla olevalle erkanemiskaistalle',
                name:
                  'Aja vasemmalla olevaa erkanemiskaistaa tielle {way_name}',
                destination:
                  'Aja vasemmalla olevalle erkanemiskaistalle suuntana {destination}',
                exit: 'Ota poistuminen {exit} vasemmalla',
                exit_destination:
                  'Ota poistuminen {exit} vasemmalla, suuntana {destination}',
              },
              right: {
                default: 'Aja oikealla olevalle erkanemiskaistalle',
                name: 'Aja oikealla olevaa erkanemiskaistaa tielle {way_name}',
                destination:
                  'Aja oikealla olevalle erkanemiskaistalle suuntana {destination}',
                exit: 'Ota poistuminen {exit} oikealla',
                exit_destination:
                  'Ota poistuminen {exit} oikealla, suuntana {destination}',
              },
              'sharp left': {
                default: 'Aja vasemmalla olevalle erkanemiskaistalle',
                name:
            ...
            rotary: {
              default: {
                default: {
                  ...
                  name:
                    'Aja liikenneympyrään ja valitse erkanemiskaista tielle {way_name}',
                  destination:
                    'Aja liikenneympyrään ja valitse erkanemiskaista suuntana {destination}',
                },
                name: {
                  default: 'Aja liikenneympyrään {rotary_name}',
                  name:
                    'Aja liikenneympyrään {rotary_name} ja valitse erkanemiskaista tielle {way_name}',
                  destination:
                    'Aja liikenneympyrään {rotary_name} ja valitse erkanemiskaista suuntana {destination}',
                },
                exit: {
                  default:
                    'Aja liikenneympyrään ja valitse {exit_number} erkanemiskaista',
                  name:
                    'Aja liikenneympyrään ja valitse {exit_number} erkanemiskaista tielle {way_name}',
                  destination:
                    'Aja liikenneympyrään ja valitse {exit_number} erkanemiskaista suuntana {destination}',
                },
                name_exit: {
                  default:
                    'Aja liikenneympyrään {rotary_name} ja valitse {exit_number} erkanemiskaista',
                  name:
                    'Aja liikenneympyrään {rotary_name} ja valitse {exit_number} erkanemiskaista tielle {way_name}',
                  destination:
                    'Aja liikenneympyrään {rotary_name} ja valitse {exit_number} erkanemiskaista suuntana {destination}',
                },
              },
            },
            roundabout: {
          ...
          v5: {
            ...
            modes: {
              ferry: {
                ...
                destination:
                  'Prendre le ferry en direction {destination:preposition}',
              },
            },
            phrase: {
              'two linked by distance':
                '{instruction_one}, puis, dans {distance}, {instruction_two}',
            ...
            arrive: {
              ...
              left: {
                default:
                  'Vous êtes arrivé à votre {nth} destination, sur la gauche',
                upcoming:
                  'Vous arriverez à votre {nth} destination, sur la gauche',
                short: 'Vous êtes arrivé',
                'short-upcoming': 'Vous arriverez',
                named:
                  'Vous êtes arrivé {waypoint_name:arrival}, sur la gauche',
              },
              right: {
                default:
                  'Vous êtes arrivé à votre {nth} destination, sur la droite',
                upcoming:
                  'Vous arriverez à votre {nth} destination, sur la droite',
                short: 'Vous êtes arrivé',
                'short-upcoming': 'Vous arriverez',
                named:
                  'Vous êtes arrivé à  {waypoint_name:arrival}, sur la droite',
              },
              'sharp left': {
                default:
                  'Vous êtes arrivé à votre {nth} destination, sur la gauche',
              ...
              'sharp right': {
                ...
                'short-upcoming': 'Vous arriverez',
                named:
                  'Vous êtes arrivé {waypoint_name:arrival}, sur la droite',
              },
              'slight right': {
                default:
                  'Vous êtes arrivé à votre {nth} destination, sur la droite',
              ...
              straight: {
                default:
                  'Vous êtes arrivé à votre {nth} destination, droit devant',
                upcoming:
                  'Vous arriverez à votre {nth} destination, droit devant',
                short: 'Vous êtes arrivé',
                'short-upcoming': 'Vous êtes arrivé',
            ...
            continue: {
              default: {
                ...
                destination:
                  'Tourner {modifier} en direction {destination:preposition}',
              ...
              straight: {
                ...
                destination:
                  'Continuer tout droit en direction {destination:preposition}',
              ...
              'sharp left': {
                ...
                name:
                  'Tourner franchement à gauche pour rester sur {way_name:article}',
                destination:
                  'Tourner franchement à gauche en direction {destination:preposition}',
              },
              'sharp right': {
                default: 'Tourner franchement à droite',
                name:
                  'Tourner franchement à droite pour rester sur {way_name:article}',
                destination:
                  'Tourner franchement à droite en direction {destination:preposition}',
              },
              'slight left': {
                default: 'Tourner légèrement à gauche',
                name:
                  'Tourner légèrement à gauche pour rester sur {way_name:article}',
                destination:
                  'Tourner légèrement à gauche en direction {destination:preposition}',
              },
              'slight right': {
                default: 'Tourner légèrement à droite',
                name:
                  'Tourner légèrement à droite pour rester sur {way_name:article}',
                destination:
                  'Tourner légèrement à droite en direction {destination:preposition}',
              },
              uturn: {
                default: 'Faire demi-tour',
                name: 'Faire demi-tour et continuer sur {way_name:article}',
                destination:
                  'Faire demi-tour en direction {destination:preposition}',
              },
            },
            depart: {
              default: {
                ...
                namedistance:
                  'Se diriger vers {direction} sur {way_name:article} sur {distance}',
              },
            },
            'end of road': {
              default: {
              ...
              uturn: {
                ...
                destination:
                  'Faire demi-tour à la fin de la route en direction {destination:preposition}',
              },
            },
            fork: {
              default: {
            ...
            merge: {
              default: {
                ...
                destination:
                  'S’insérer {modifier} en direction {destination:preposition}',
              },
              straight: {
                default: 'S’insérer',
              ...
              'slight left': {
                ...
                destination:
                  'S’insérer légèrement à gauche en direction {destination:preposition}',
              },
              'slight right': {
                default: 'S’insérer légèrement à droite',
                name: 'S’insérer légèrement à droite sur {way_name:article}',
                destination:
                  'S’insérer à droite en direction {destination:preposition}',
              },
              'sharp left': {
                default: 'S’insérer à gauche',
                name: 'S’insérer à gauche sur {way_name:article}',
                destination:
                  'S’insérer à gauche en direction {destination:preposition}',
              },
              'sharp right': {
            ...
            'new name': {
              default: {
                ...
                destination:
                  'Continuer {modifier} en direction {destination:preposition}',
              },
              straight: {
                default: 'Continuer tout droit',
                name: 'Continuer tout droit sur {way_name:article}',
              ...
              'slight left': {
                ...
                destination:
                  'Continuer légèrement à gauche en direction {destination:preposition}',
              },
              'slight right': {
                default: 'Continuer légèrement à droite',
                name: 'Continuer légèrement à droite sur {way_name:article}',
                destination:
                  'Continuer légèrement à droite en direction {destination:preposition}',
              },
              uturn: {
                default: 'Faire demi-tour',
                name: 'Faire demi-tour sur {way_name:article}',
            ...
            'off ramp': {
              default: {
                ...
                destination:
                  'Prendre la sortie en direction {destination:preposition}',
                exit: 'Prendre la sortie {exit}',
                exit_destination:
                  'Prendre la sortie {exit} en direction {destination:preposition}',
              },
              left: {
                default: 'Prendre la sortie à gauche',
                name: 'Prendre la sortie à gauche sur {way_name:article}',
                destination:
                  'Prendre la sortie à gauche en direction {destination:preposition}',
                exit: 'Prendre la sortie {exit} sur la gauche',
                exit_destination:
                  'Prendre la sortie {exit} sur la gauche en direction {destination:preposition}',
              },
              right: {
                default: 'Prendre la sortie à droite',
                name: 'Prendre la sortie à droite sur {way_name:article}',
                destination:
                  'Prendre la sortie à droite en direction {destination:preposition}',
                exit: 'Prendre la sortie {exit} sur la droite',
                exit_destination:
                  'Prendre la sortie {exit} sur la droite en direction {destination:preposition}',
              },
              'sharp left': {
                default: 'Prendre la sortie à gauche',
                name: 'Prendre la sortie à gauche sur {way_name:article}',
            ...
            rotary: {
              default: {
                default: {
                  ...
                  name:
                    'Prendre le rond-point, puis sortir sur {way_name:article}',
                  destination:
                    'Prendre le rond-point, puis sortir en direction {destination:preposition}',
                },
                name: {
                  default: 'Prendre {rotary_name:rotary}',
                  name:
                    'Prendre {rotary_name:rotary}, puis sortir par {way_name:article}',
                  destination:
                    'Prendre {rotary_name:rotary}, puis sortir en direction {destination:preposition}',
                },
                exit: {
                  default:
                    'Prendre le rond-point, puis la {exit_number} sortie',
                  name:
                    'Prendre le rond-point, puis la {exit_number} sortie sur {way_name:article}',
                  destination:
                    'Prendre le rond-point, puis la {exit_number} sortie en direction {destination:preposition}',
                },
                name_exit: {
                  default:
                    'Prendre {rotary_name:rotary}, puis la {exit_number} sortie',
                  name:
                    'Prendre {rotary_name:rotary}, puis la {exit_number} sortie sur {way_name:article}',
                  destination:
                    'Prendre {rotary_name:rotary}, puis la {exit_number} sortie en direction {destination:preposition}',
                },
              },
            },
            roundabout: {
            ...
            'roundabout turn': {
              ...
              left: {
                ...
                destination:
                  'Tourner à gauche en direction {destination:preposition}',
              },
              right: {
                default: 'Tourner à droite',
                name: 'Tourner à droite sur {way_name:article}',
                destination:
                  'Tourner à droite en direction {destination:preposition}',
              },
              straight: {
                default: 'Continuer tout droit',
                name: 'Continuer tout droit sur {way_name:article}',
            ...
            'exit roundabout': {
              default: {
                ...
                destination:
                  'Sortir du rond-point en direction {destination:preposition}',
              },
            },
            'exit rotary': {
              default: {
            ...
            turn: {
              ...
              straight: {
                ...
                destination:
                  'Aller tout droit en direction {destination:preposition}',
              },
            },
            'use lane': {
              no_lanes: {
      ...
      function (_dereq_, module, exports) {
        module.exports = {
          ...
          v5: {
            ...
            phrase: {
              'two linked by distance':
                '{instruction_one}, ואז, בעוד{distance}, {instruction_two}',
            ...
            depart: {
              default: {
                ...
                namedistance:
                  'התכוונן {direction} על {way_name} לאורך {distance}',
              },
            },
            'end of road': {
              default: {
            ...
            'off ramp': {
              ...
              left: {
                ...
                exit_destination:
                  'צא ביציאה {exit} משמאלך לכיוון {destination}',
              },
              right: {
                ...
                exit_destination:
                  'צא ביציאה {exit} מימינך לכיוון {destination}',
              },
              'sharp left': {
            ...
            rotary: {
              default: {
                ...
                exit: {
                  ...
                  name:
                    'השתלב במעגל התנועה וצא ביציאה {exit_number} ל{way_name}',
                  destination:
                    'השתלב במעגל התנועה וצא ביציאה {exit_number} לכיוון {destination}',
                },
                name_exit: {
                  default: 'היכנס ל{rotary_name} וצא ביציאה ה{exit_number}',
                  name:
                    'היכנס ל{rotary_name} וצא ביציאה ה{exit_number} ל{way_name}',
                  destination:
                    'היכנס ל{rotary_name} וצא ביציאה ה{exit_number} לכיוון {destination}',
                },
              },
            },
            roundabout: {
          ...
          v5: {
            ...
            fork: {
              default: {
                ...
                destination:
                  'Tetap {modifier} di pertigaan menuju {destination}',
              },
              'slight left': {
                default: 'Tetap di kiri pada pertigaan',
                name: 'Tetap di kiri pada pertigaan ke arah {way_name}',
                destination:
                  'Tetap di kiri pada pertigaan menuju {destination}',
              },
              'slight right': {
                default: 'Tetap di kanan pada pertigaan',
                name: 'Tetap di kanan pada pertigaan ke arah {way_name}',
                destination:
                  'Tetap di kanan pada pertigaan menuju {destination}',
              },
              'sharp left': {
            ...
            'off ramp': {
              ...
              left: {
                ...
                destination:
                  'Ambil jalan melandai di sebelah kiri menuju {destination}',
                exit: 'Take exit {exit} on the left',
                exit_destination:
                  'Take exit {exit} on the left towards {destination}',
              },
              right: {
                ...
                destination:
                  'Ambil jalan melandai di sebelah kanan menuju {destination}',
                exit: 'Take exit {exit} on the right',
                exit_destination:
                  'Take exit {exit} on the right towards {destination}',
              },
            ...
            rotary: {
              default: {
                ...
                name: {
                  ...
                  destination:
                    'Masuk {rotary_name} dan keluar menuju {destination}',
                },
                exit: {
                  default:
                    'Masuk bundaran dan ambil jalan keluar {exit_number}',
                  name:
                    'Masuk bundaran dan ambil jalan keluar {exit_number} arah {way_name}',
                  destination:
                    'Masuk bundaran dan ambil jalan keluar {exit_number} menuju {destination}',
                },
                name_exit: {
                  default:
                    'Masuk {rotary_name} dan ambil jalan keluar {exit_number}',
                  name:
                    'Masuk {rotary_name} dan ambil jalan keluar {exit_number} arah {way_name}',
                  destination:
                    'Masuk {rotary_name} dan ambil jalan keluar {exit_number} menuju {destination}',
                },
              },
            },
            roundabout: {
      ...
      function (_dereq_, module, exports) {
        module.exports = {
          ...
          v5: {
            ...
            phrase: {
              'two linked by distance':
                '{instruction_one}, poi tra {distance},{instruction_two}',
            ...
            arrive: {
              ...
              left: {
                default:
                  'sei arrivato alla tua {nth} destinazione, sulla sinistra',
                upcoming:
                  'sei arrivato alla tua {nth} destinazione, sulla sinistra',
                short: 'Sei arrivato alla tua {nth} destinazione',
                'short-upcoming': 'Sei arrivato alla tua {nth} destinazione',
              ...
              right: {
                default:
                  'sei arrivato alla tua {nth} destinazione, sulla destra',
                upcoming:
                  'sei arrivato alla tua {nth} destinazione, sulla destra',
                short: 'Sei arrivato alla tua {nth} destinazione',
                'short-upcoming': 'Sei arrivato alla tua {nth} destinazione',
              ...
              straight: {
                default:
                  'sei arrivato alla tua {nth} destinazione, si trova davanti a te',
                upcoming:
                  'sei arrivato alla tua {nth} destinazione, si trova davanti a te',
                short: 'Sei arrivato alla tua {nth} destinazione',
                'short-upcoming': 'Sei arrivato alla tua {nth} destinazione',
            ...
            continue: {
              ...
              'sharp left': {
                ...
                name:
                  'Fai una stretta curva a sinistra per stare su {way_name}',
              ...
              'slight left': {
                ...
                name:
                  'Fai una leggera curva a sinistra per stare su {way_name}',
                destination:
                  'Fai una leggera curva a sinistra verso {destination}',
              },
              'slight right': {
                default: 'Fai una leggera curva a destra',
                name: 'Fai una leggera curva a destra per stare su {way_name}',
                destination:
                  'Fai una leggera curva a destra verso {destination}',
              },
              uturn: {
            ...
            'end of road': {
              ...
              uturn: {
                ...
                name:
                  "Fai un'inversione a U in {way_name} alla fine della strada",
                destination:
                  "Fai un'inversione a U verso {destination} alla fine della strada",
              },
            },
            fork: {
              default: {
                ...
                destination:
                  'Mantieni la {modifier} al bivio verso {destination}',
              },
              'slight left': {
                default: 'Mantieni la sinistra al bivio',
                name: 'Mantieni la sinistra al bivio in {way_name}',
                destination:
                  'Mantieni la sinistra al bivio verso {destination}',
              },
              'slight right': {
            ...
            'new name': {
              ...
              'slight left': {
                ...
                destination:
                  'Continua leggermente a sinistra verso {destination}',
              },
              'slight right': {
                default: 'Continua leggermente a destra',
                name: 'Continua leggermente a destra in {way_name} ',
                destination:
                  'Continua leggermente a destra verso {destination}',
              },
              uturn: {
                default: "Fai un'inversione a U",
                name: "Fai un'inversione a U in {way_name}",
            ...
            'off ramp': {
              ...
              left: {
                ...
                exit_destination:
                  'Prendi la {exit}  uscita a sinistra verso {destination}',
              },
              right: {
                ...
                exit_destination:
                  'Prendi la {exit} uscita a destra verso {destination}',
              },
              'sharp left': {
                default: 'Prendi la rampa a sinistra',
                name: 'Prendi la rampa a sinistra in {way_name}',
            ...
            rotary: {
              default: {
                default: {
                  ...
                  destination:
                    'Immettiti nella ritonda ed esci verso {destination}',
                },
                name: {
                  default: 'Immettiti in {rotary_name}',
                  name: 'Immettiti in {rotary_name} ed esci su {way_name}',
                  destination:
                    'Immettiti in {rotary_name} ed esci verso {destination}',
                },
                exit: {
                  default:
                    'Immettiti nella rotonda e prendi la {exit_number} uscita',
                  name:
                    'Immettiti nella rotonda e prendi la {exit_number} uscita in {way_name}',
                  destination:
                    'Immettiti nella rotonda e prendi la {exit_number} uscita verso   {destination}',
                },
                name_exit: {
                  default:
                    'Immettiti in {rotary_name} e prendi la {exit_number} uscita',
                  name:
                    'Immettiti in {rotary_name} e prendi la {exit_number} uscita in {way_name}',
                  destination:
                    'Immettiti in {rotary_name} e prendi la {exit_number}  uscita verso {destination}',
                },
              },
            },
            roundabout: {
              default: {
                ...
                default: {
                  ...
                  destination:
                    "Entra nella rotonda e prendi l'uscita verso {destination}",
                },
              },
            },
            'roundabout turn': {
      ...
      function (_dereq_, module, exports) {
        module.exports = {
          ...
          v5: {
            ...
            phrase: {
              'two linked by distance':
                '{instruction_one}, 그리고, {distance} 안에, {instruction_two}',
            ...
            depart: {
              default: {
                ...
                namedistance:
                  '{direction}로 가서{way_name} 를 {distance}까지 가세요.',
              },
            },
            'end of road': {
              default: {
              ...
              uturn: {
                ...
                destination:
                  '도로 끝까지 가서 유턴해서 {destination} 까지 가세요.',
              },
            },
            fork: {
              default: {
            ...
            'off ramp': {
              default: {
                ...
                exit: '{exit} 출구로 나가세요.',
                exit_destination:
                  '{exit} 출구로 나가서 {destination}까지 가세요.',
              },
              left: {
                ...
                exit_destination:
                  '{exit} 왼쪽의 출구로 가나서 {destination}까지 가세요.',
              },
              right: {
                default: '오른쪽의 램프로 진출해 주세요.',
                name: '오른쪽의 램프로 진출해서 {way_name}로 가세요.',
                destination:
                  '오른쪽의 램프로 진출해서 {destination}까지 가세요.',
                exit: '{exit} 오른쪽의 출구로 나가세요.',
                exit_destination:
                  '{exit} 오른쪽의 출구로 가나서 {destination}까지 가세요.',
              },
              'sharp left': {
                default: '왼쪽의 램프로 진출해 주세요.',
                name: '왼쪽의 램프로 진출해서 {way_name}로 가세요.',
            ...
            'on ramp': {
              ...
              right: {
                ...
                destination:
                  '오른쪽의 램프로 진입해서 {destination}까지 가세요.',
              },
              'sharp left': {
                default: '왼쪽의 램프로 진입해 주세요.',
                name: '왼쪽의 램프로 진입해서 {way_name}로 가세요.',
            ...
            rotary: {
              default: {
                ...
                name: {
                  ...
                  destination:
                    '{rotary_name}로 진입해서 {destination}로 나가세요.',
                },
                exit: {
                  default: '로터리로 진입해서 {exit_number} 출구로 나가세요.',
                  name:
                    '로터리로 진입해서 {exit_number} 출구로 나가 {way_name}로 가세요.',
                  destination:
                    '로터리로 진입해서 {exit_number} 출구로 나가 {destination}로 가세요.',
                },
                name_exit: {
                  default:
                    '{rotary_name}로 진입해서 {exit_number}번 출구로 나가세요.',
                  name:
                    '{rotary_name}로 진입해서 {exit_number}번 출구로 나가 {way_name}로 가세요.',
                  destination:
                    '{rotary_name}로 진입해서 {exit_number}번 출구로 나가 {destination}로 가세요.',
                },
              },
            },
            roundabout: {
              default: {
                exit: {
                  ...
                  name:
                    '로터리로 진입해서 {exit_number}로 나가서 {way_name}로 가세요.',
                  destination:
                    '로터리로 진입해서 {exit_number}로 나가서 {destination}로 가세요.',
                },
                default: {
                  default: '로터리로 진입하세요.',
                  name: '로터리로 진입해서 {way_name} 나가세요.',
      ...
      function (_dereq_, module, exports) {
        module.exports = {
          ...
          v5: {
            ...
            phrase: {
              'two linked by distance':
                '{instruction_one}ျပီးေနာက္ {distance}အတြင္း {instruction_two}',
            ...
            arrive: {
              ...
              left: {
                default:
                  'သင္ သြားလိုေသာ {nth}ခရီးပန္းတိုင္သို႕ဘယ္ဘက္တြင္ေရာက္ရွိျပီ',
                upcoming:
                  'သင္ သြားလိုေသာ {nth}ခရီးပန္းတိုင္သို႕ဘယ္ဘက္တြင္ေရာက္လိမ့္မည္',
                short: 'သင္သြားလိုေသာ ေနရာသို႔ ေရာက္ရိွၿပီ',
                'short-upcoming': 'သင္သြားလိုေသာ ေနရာသို႔ ေရာက္လိမ့္မည္',
              ...
              right: {
                default:
                  'သင္ သြားလိုေသာ {nth}ခရီးပန္းတိုင္သို႕ ညာဘက္ေကြ႕ကာ ေရာက္ရွိျပီ',
                upcoming:
                  'သင္ သြားလိုေသာ{nth} ခရီးပန္းတိုင္သို႕ ညာဘက္ေကြ႕ကာ ေရာက္လိမ့္မည္',
                short: 'သင္သြားလိုေသာ ေနရာသို႔ ေရာက္ရိွၿပီ',
                'short-upcoming': 'သင္သြားလိုေသာ ေနရာသို႔ ေရာက္လိမ့္မည္',
              ...
              straight: {
                default:
                  'သင္ သြားလိုေသာ {nth}ခရီးပန္းတိုင္သို႕တည့္တည့္သြားကာရာက္ရွိျပီ',
                upcoming:
            ...
            depart: {
              default: {
                ...
                namedistance:
                  '{direction}ကို {way_name}အေပၚတြင္{distance}ေလာက္ ဦးတည္ဆက္သြားပါ',
              },
            },
            'end of road': {
              default: {
              ...
              uturn: {
                ...
                destination:
                  'လမ္းအဆံုးတြင္{destination}ဆီသို႕ ဂေကြ႕ခ်ိဳးေကြ႕ပါ',
              },
            },
            fork: {
              default: {
            ...
            merge: {
              default: {
                ...
                destination:
                  '{destination}ဆီသို႕ {modifier}ကို လာေရာက္ေပါင္းဆံုပါ',
              },
              straight: {
            ...
            'off ramp': {
              ...
              left: {
                ...
                destination:
                  '{destination}ဆီသို႕ ဘယ္ဘက္​ေပၚတြင္ခ်ဥ္းကပ္လမ္းကိုယူပါ',
              ...
              right: {
                ...
                destination:
                  '{destination}ဆီသို႕ ညာဘက္​ေပၚတြင္ခ်ဥ္းကပ္လမ္းကိုယူပါ',
            ...
            rotary: {
              default: {
                ...
                name: {
                  ...
                  destination:
                    '{rotary_name}အဝိုင္းပတ္ဝင္ျပီး{destination}ဆီသို႕ထြက္ပါ',
                },
                exit: {
                  default: 'အဝိုင္းပတ္ဝင္ျပီး{exit_number}ကိုယူကာျပန္ထြက္ပါ',
                  name:
                    'အဝိုင္းပတ္သို႕ဝင္ျပီး{exit_number}ကိုယူကာ{way_name}ေပၚသို႕ထြက္ပါ',
                  destination:
                    'အဝိုင္းပတ္ဝင္ျပီး{exit_number}ကိုယူကာ{destination}ဆီသို႕ထြက္ပါ',
                },
                name_exit: {
                  default: '{rotary_name}ကိုဝင္ျပီး {exit_number}ကိုယူကာထြက္ပါ',
                  name:
                    '{rotary_name}ကိုဝင္ျပီး{exit_number}ကိုယူကာ{way_name}ေပၚသို႕ထြက္ပါ',
                  destination:
                    '{rotary_name}ဝင္ျပီး{exit_number}ကိုယူကာ{destination}ဆီသို႕ထြက္ပါ',
                },
              },
            },
            roundabout: {
              default: {
                exit: {
                  ...
                  name:
                    'အဝိုင္းပတ္ဝင္ျပီး{exit_number}ကိုယူကာ{way_name}ေပၚသို႕ထြက္ပါ',
                  destination:
                    'အဝိုင္းပတ္ဝင္ျပီး{exit_number}ကိုယူကာ{destination}ဆီသို႕ထြက္ပါ',
                },
                default: {
      ...
      function (_dereq_, module, exports) {
        module.exports = {
          ...
          v5: {
            ...
            phrase: {
              'two linked by distance':
                '{instruction_one}, dan na {distance}, {instruction_two}',
            ...
            arrive: {
              ...
              left: {
                ...
                'short-upcoming': 'U zult aankomen',
                named:
                  'U bent gearriveerd bij {waypoint_name}, de bestemming is aan de linkerkant',
              },
              right: {
                default:
                ...
                'short-upcoming': 'U zult aankomen',
                named:
                  'U bent gearriveerd bij {waypoint_name}, de bestemming is aan de  rechterkant',
              },
              'sharp left': {
                default:
                  'Je bent gearriveerd. De {nth} bestemming bevindt zich links.',
              ...
              straight: {
                ...
                'short-upcoming': 'U zult aankomen',
                named:
                  'U bent gearriveerd bij {waypoint_name}, de bestemming is recht voor u',
              },
            },
            continue: {
              default: {
            ...
            depart: {
              default: {
                ...
                namedistance:
                  'Ga richting {direction} op {way_name} voor {distance}',
              },
            },
            'end of road': {
              default: {
            ...
            fork: {
              default: {
                ...
                destination:
                  'Houd {modifier}, in de richting van {destination}',
              },
              'slight left': {
              ...
              'sharp left': {
                default:
                  'Neem bij de splitsing, een scherpe bocht, naar links ',
                name: 'Neem een scherpe bocht naar links, tot aan {way_name}',
                destination:
                  'Neem een scherpe bocht naar links, richting {destination}',
              },
              'sharp right': {
                default:
                  'Neem  op de splitsing, een scherpe bocht, naar rechts',
                name: 'Neem een scherpe bocht naar rechts, tot aan {way_name}',
                destination:
                  'Neem een scherpe bocht naar rechts, richting {destination}',
              },
              uturn: {
                default: 'Keer om',
                name: 'Keer om naar {way_name}',
            ...
            merge: {
              default: {
                ...
                destination:
                  'Bij de splitsing {modifier} richting {destination}',
              },
              straight: {
                default: 'Samenvoegen',
            ...
            'off ramp': {
              ...
              left: {
                ...
                exit_destination:
                  'Neem afslag {exit} aan de linkerkant richting {destination}',
              },
              right: {
                ...
                exit_destination:
                  'Neem afslag {exit} aan de rechterkant richting {destination}',
              },
              'sharp left': {
                default: 'Neem de afrit links',
                name: 'Neem de afrit links naar {way_name}',
            ...
            rotary: {
              default: {
                default: {
                  ...
                  destination:
                    'Betreedt rotonde en sla af richting {destination}',
                },
                name: {
                  default: 'Ga het knooppunt {rotary_name} op',
                  name: 'Verlaat het knooppunt {rotary_name} naar {way_name}',
                  destination:
                    'Verlaat het knooppunt {rotary_name} richting {destination}',
                },
                exit: {
                  default: 'Betreedt rotonde en neem afslag {exit_number}',
                  name:
                    'Betreedt rotonde en neem afslag {exit_number} naar {way_name}',
                  destination:
                    'Betreedt rotonde en neem afslag {exit_number} richting {destination}',
                },
                name_exit: {
                  default:
                    'Ga het knooppunt {rotary_name} op en neem afslag {exit_number}',
                  name:
                    'Ga het knooppunt {rotary_name} op en neem afslag {exit_number} naar {way_name}',
                  destination:
                    'Ga het knooppunt {rotary_name} op en neem afslag {exit_number} richting {destination}',
                },
              },
            },
            roundabout: {
      ...
      function (_dereq_, module, exports) {
        module.exports = {
          ...
          v5: {
            ...
            phrase: {
              'two linked by distance':
                '{instruction_one}, deretter {instruction_two} om {distance}',
            ...
            arrive: {
              ...
              left: {
                default:
                  'Du har ankommet din {nth} destinasjon, på din venstre side',
                upcoming:
                  'Du vil ankomme din {nth} destinasjon, på din venstre side',
                short: 'Du har ankommet',
                'short-upcoming': 'Du vil ankomme',
              ...
              right: {
                default:
                  'Du har ankommet din {nth} destinasjon, på din høyre side',
                upcoming:
                  'Du vil ankomme din {nth} destinasjon, på din høyre side',
                short: 'Du har ankommet',
                'short-upcoming': 'Du vil ankomme',
            ...
            continue: {
              ...
              'sharp left': {
                ...
                name:
                  'Sving skarpt til venstre for å bli værende på {way_name}',
            ...
            depart: {
              default: {
                ...
                namedistance:
                  'Kjør i retning {direction} på {way_name}, {distance}',
              },
            },
            'end of road': {
              default: {
            ...
            'off ramp': {
              ...
              left: {
                ...
                exit_destination:
                  'Ta avkjørsel {exit} på venstre side mot {destination}',
              },
              right: {
                ...
                exit_destination:
                  'Ta avkjørsel {exit} på høyre side mot {destination}',
              },
              'sharp left': {
                default: 'Ta avkjørselen på venstre side',
                name: 'Ta avkjørselen på venstre side inn på {way_name}',
            ...
            rotary: {
              default: {
                default: {
                  ...
                  destination:
                    'Kjør inn i rundkjøringen og deretter ut mot {destination}',
                },
                name: {
                  default: 'Kjør inn i {rotary_name}',
                  name: 'Kjør inn i {rotary_name} og deretter ut på {way_name}',
                  destination:
                    'Kjør inn i {rotary_name} og deretter ut mot {destination}',
                },
                exit: {
                  default:
                    'Kjør inn i rundkjøringen og ta {exit_number} avkjørsel',
                  name:
                    'Kjør inn i rundkjøringen og ta {exit_number} avkjørsel ut på {way_name}',
                  destination:
                    'Kjør inn i rundkjøringen og ta {exit_number} avkjørsel ut mot {destination} ',
                },
                name_exit: {
                  default:
                    'Kjør inn i {rotary_name} og ta {exit_number} avkjørsel',
                  name:
                    'Kjør inn i {rotary_name} og ta {exit_number} avkjørsel inn på {way_name}',
                  destination:
                    'Kjør inn i {rotary_name} og ta {exit_number} avkjørsel mot {destination}',
                },
              },
            },
            roundabout: {
              default: {
                exit: {
                  default:
                    'Kjør inn i rundkjøringen og ta {exit_number} avkjørsel',
                  name:
                    'Kjør inn i rundkjøringen og ta {exit_number} avkjørsel inn på {way_name}',
                  destination:
                    'Kjør inn i rundkjøringen og ta {exit_number} avkjørsel ut mot {destination} ',
                },
                default: {
      ...
      function (_dereq_, module, exports) {
        module.exports = {
          ...
          v5: {
            ...
            phrase: {
              'two linked by distance':
                '{instruction_one}, następnie za {distance} {instruction_two}',
            ...
            merge: {
              ...
              'slight left': {
                ...
                destination:
                  'Włącz się z lewej strony w kierunku {destination}',
              },
              'slight right': {
                default: 'Włącz się z prawej strony',
                name: 'Włącz się z prawej strony na {way_name}',
                destination:
                  'Włącz się z prawej strony w kierunku {destination}',
              },
              'sharp left': {
                default: 'Włącz się z lewej strony',
                name: 'Włącz się z lewej strony na {way_name}',
            ...
            'new name': {
              ...
              'slight left': {
                ...
                destination:
                  'Kontynuuj łagodnie w lewo w kierunku {destination}',
              },
              'slight right': {
                default: 'Kontynuuj łagodnie w prawo',
                name: 'Kontynuuj łagodnie w prawo na {way_name}',
                destination:
                  'Kontynuuj łagodnie w prawo w kierunku {destination}',
              },
              uturn: {
                default: 'Zawróć',
                name: 'Zawróć na {way_name}',
            ...
            'off ramp': {
              ...
              left: {
                ...
                exit_destination:
                  'Zjedź zjazdem {exit} po lewej stronie na {destination}',
              },
              right: {
                ...
                exit_destination:
                  'Zjedź zjazdem {exit} po prawej stronie na {destination}',
              },
              'sharp left': {
                default: 'Weź zjazd po lewej',
                name: 'Weź zjazd po lewej na {way_name}',
            ...
            rotary: {
              default: {
                default: {
                  ...
                  destination:
                    'Wjedź na rondo i skręć w kierunku {destination}',
                },
                name: {
                  default: 'Wjedź na {rotary_name}',
                  name: 'Wjedź na {rotary_name} i skręć na {way_name}',
                  destination:
                    'Wjedź na {rotary_name} i skręć w kierunku {destination}',
                },
                exit: {
                  default: 'Wjedź na rondo i wyjedź {exit_number} zjazdem',
                  name:
                    'Wjedź na rondo i wyjedź {exit_number} zjazdem na {way_name}',
                  destination:
                    'Wjedź na rondo i wyjedź {exit_number} zjazdem w kierunku {destination}',
                },
                name_exit: {
                  default:
                    'Wjedź na {rotary_name} i wyjedź {exit_number} zjazdem',
                  name:
                    'Wjedź na {rotary_name} i wyjedź {exit_number} zjazdem na {way_name}',
                  destination:
                    'Wjedź na {rotary_name} i wyjedź {exit_number} zjazdem w kierunku {destination}',
                },
              },
            },
            roundabout: {
              default: {
                ...
                default: {
                  ...
                  destination:
                    'Wjedź na rondo i wyjedź w kierunku {destination}',
                },
              },
            },
            'roundabout turn': {
      ...
      function (_dereq_, module, exports) {
        module.exports = {
          ...
          v5: {
            ...
            phrase: {
              'two linked by distance':
                '{instruction_one}, então, em {distance}, {instruction_two}',
            ...
            continue: {
              ...
              'sharp left': {
                ...
                name:
                  'Faça uma curva fechada a esquerda para manter-se na {way_name}',
                destination:
                  'Faça uma curva fechada a esquerda sentido {destination}',
              },
              'sharp right': {
                default: 'Faça uma curva fechada a direita',
                name:
                  'Faça uma curva fechada a direita para manter-se na {way_name}',
                destination:
                  'Faça uma curva fechada a direita sentido {destination}',
              },
              'slight left': {
                default: 'Faça uma curva suave a esquerda',
                name:
                  'Faça uma curva suave a esquerda para manter-se na {way_name}',
                destination:
                  'Faça uma curva suave a esquerda em direção a {destination}',
              },
              'slight right': {
                default: 'Faça uma curva suave a direita',
                name:
                  'Faça uma curva suave a direita para manter-se na {way_name}',
                destination:
                  'Faça uma curva suave a direita em direção a {destination}',
              },
              uturn: {
            ...
            'end of road': {
              ...
              uturn: {
                ...
                destination:
                  'Faça o retorno sentido {destination} no fim da rua',
              },
            },
            fork: {
              default: {
            ...
            'new name': {
              ...
              'slight left': {
                ...
                destination:
                  'Continue ligeiramente à esquerda sentido {destination}',
              },
              'slight right': {
                default: 'Continue ligeiramente à direita',
                name: 'Continue ligeiramente à direita em {way_name}',
                destination:
                  'Continue ligeiramente à direita sentido {destination}',
              },
              uturn: {
                default: 'Faça o retorno',
                name: 'Faça o retorno em {way_name}',
            ...
            'off ramp': {
              default: {
                ...
                exit_destination:
                  'Pegue a saída {exit} em direção à {destination}',
              },
              left: {
                ...
                exit_destination:
                  'Pegue a saída {exit}  à esquerda em direção à {destination}',
              },
              right: {
                ...
                exit_destination:
                  'Pegue a saída {exit} à direita em direção à {destination}',
              },
              'sharp left': {
                default: 'Pegue a rampa à esquerda',
                name: 'Pegue a rampa à esquerda em {way_name}',
            ...
            rotary: {
              default: {
                default: {
                  ...
                  destination:
                    'Entre na rotatória e saia sentido {destination}',
                },
                name: {
                  default: 'Entre em {rotary_name}',
                  name: 'Entre em {rotary_name} e saia em {way_name}',
                  destination:
                    'Entre em {rotary_name} e saia sentido {destination}',
                },
                exit: {
                  default: 'Entre na rotatória e pegue a {exit_number} saída',
                  name:
                    'Entre na rotatória e pegue a {exit_number} saída na {way_name}',
                  destination:
                    'Entre na rotatória e pegue a {exit_number} saída sentido {destination}',
                },
                name_exit: {
                  default:
                    'Entre em {rotary_name} e saia na {exit_number} saída',
                  name:
                    'Entre em {rotary_name} e saia na {exit_number} saída em {way_name}',
                  destination:
                    'Entre em {rotary_name} e saia na {exit_number} saída sentido {destination}',
                },
              },
            },
            roundabout: {
      ...
      function (_dereq_, module, exports) {
        module.exports = {
          ...
          v5: {
            ...
            phrase: {
              'two linked by distance':
                '{instruction_one}, depois, a {distance}, {instruction_two}',
            ...
            continue: {
              ...
              'sharp left': {
                ...
                name:
                  'Vire acentuadamente à esquerda para se manter em {way_name}',
                destination:
                  'Vire acentuadamente à esquerda em direção a {destination}',
              },
              'sharp right': {
                default: 'Vire acentuadamente à direita',
                name:
                  'Vire acentuadamente à direita para se manter em {way_name}',
                destination:
                  'Vire acentuadamente à direita em direção a {destination}',
              },
              'slight left': {
                default: 'Vire ligeiramente à esquerda',
                name:
                  'Vire ligeiramente à esquerda para se manter em {way_name}',
                destination:
                  'Vire ligeiramente à esquerda em direção a {destination}',
              },
              'slight right': {
                default: 'Vire ligeiramente à direita',
                name:
                  'Vire ligeiramente à direita para se manter em {way_name}',
                destination:
                  'Vire ligeiramente à direita em direção a {destination}',
              },
              uturn: {
                default: 'Faça inversão de marcha',
                name: 'Faça inversão de marcha e continue em {way_name}',
                destination:
                  'Faça inversão de marcha em direção a {destination}',
              },
            },
            depart: {
              default: {
                ...
                namedistance:
                  'Dirija-se para {direction} em {way_name} por {distance}',
              },
            },
            'end of road': {
              default: {
              ...
              uturn: {
                ...
                name:
                  'No final da estrada faça uma inversão de marcha para {way_name} ',
                destination:
                  'No final da estrada faça uma inversão de marcha em direção a {destination}',
              },
            },
            fork: {
              default: {
                ...
                destination:
                  'Mantenha-se {modifier} em direção a {destination}',
              },
              'slight left': {
                default: 'Na bifurcação mantenha-se à esquerda',
                name: 'Mantenha-se à esquerda para {way_name}',
                destination:
                  'Mantenha-se à esquerda em direção a {destination}',
              },
              'slight right': {
            ...
            merge: {
              default: {
                ...
                destination:
                  'Una-se ao tráfego {modifier} em direção a {destination}',
              },
              straight: {
              ...
              'slight left': {
                ...
                destination:
                  'Una-se ao tráfego à esquerda em direção a {destination}',
              },
              'slight right': {
                default: 'Una-se ao tráfego à direita',
                name: 'Una-se ao tráfego à direita para {way_name}',
                destination:
                  'Una-se ao tráfego à direita em direção a {destination}',
              },
              'sharp left': {
                default: 'Una-se ao tráfego à esquerda',
                name: 'Una-se ao tráfego à esquerda para {way_name}',
            ...
            'new name': {
              ...
              'slight left': {
                ...
                destination:
                  'Continue ligeiramente à esquerda em direção a {destination}',
              },
              'slight right': {
                default: 'Continue ligeiramente à direita',
                name: 'Continue ligeiramente à direita para {way_name}',
                destination:
                  'Continue ligeiramente à direita em direção a {destination}',
              },
              uturn: {
                default: 'Faça inversão de marcha',
                name: 'Faça inversão de marcha para {way_name}',
            ...
            'off ramp': {
              default: {
                ...
                exit_destination:
                  'Saia na saída {exit} em direção a {destination}',
              },
              left: {
                default: 'Saia na saída à esquerda',
                name: 'Saia na saída à esquerda para {way_name}',
                destination:
                  'Saia na saída à esquerda em direção a {destination}',
                exit: 'Saia na saída {exit} à esquerda',
                exit_destination:
                  'Saia na saída {exit} à esquerda em direção a {destination}',
              },
              right: {
                default: 'Saia na saída à direita',
                name: 'Saia na saída à direita para {way_name}',
                destination:
                  'Saia na saída à direita em direção a {destination}',
                exit: 'Saia na saída {exit} à direita',
                exit_destination:
                  'Saia na saída {exit} à direita em direção a {destination}',
              },
              'sharp left': {
                default: 'Saia na saída à esquerda',
                name: 'Saia na saída à esquerda para {way_name}',
            ...
            rotary: {
              default: {
                default: {
                  ...
                  destination:
                    'Entre na rotunda e saia em direção a {destination}',
                },
                name: {
                  default: 'Entre em {rotary_name}',
                  name: 'Entre em {rotary_name} e saia para {way_name}',
                  destination:
                    'Entre em {rotary_name} e saia em direção a {destination}',
                },
                exit: {
                  default: 'Entre na rotunda e saia na saída {exit_number}',
                  name:
                    'Entre na rotunda e saia na saída {exit_number} para {way_name}',
                  destination:
                    'Entre na rotunda e saia na saída {exit_number} em direção a {destination}',
                },
                name_exit: {
                  default:
                    'Entre em {rotary_name} e saia na saída {exit_number}',
                  name:
                    'Entre em {rotary_name} e saia na saída {exit_number} para {way_name}',
                  destination:
                    'Entre em{rotary_name} e saia na saída {exit_number} em direção a {destination}',
                },
              },
            },
            roundabout: {
      ...
      function (_dereq_, module, exports) {
        module.exports = {
          ...
          v5: {
            ...
            phrase: {
              'two linked by distance':
                '{instruction_one}, apoi în {distance}, {instruction_two}',
            ...
            depart: {
              default: {
                ...
                namedistance:
                  'Mergeți spre {direction} pe {way_name} pentru {distance}',
              },
            },
            'end of road': {
              default: {
              ...
              uturn: {
                ...
                destination:
                  'Întoarceți-vă spre {destination} la sfârșitul drumului',
              },
            },
            fork: {
              default: {
            ...
            'off ramp': {
              ...
              left: {
                ...
                exit_destination:
                  'Urmați ieșirea {exit} pe stânga spre {destination}',
              },
              right: {
                ...
                exit_destination:
                  'Urmați ieșirea {exit} pe dreapta spre {destination}',
              },
              'sharp left': {
                default: 'Urmați breteaua din stânga',
                name: 'Urmați breteaua din stânga pe {way_name}',
            ...
            rotary: {
              default: {
                default: {
                  ...
                  destination:
                    'Intrați în sensul giratoriu și ieșiți spre {destination}',
                },
                name: {
                  default: 'Intrați în {rotary_name}',
                  name: 'Intrați în {rotary_name} și ieșiți pe {way_name}',
                  destination:
                    'Intrați în {rotary_name} și ieșiți spre {destination}',
                },
                exit: {
                  default:
                    'Intrați în sensul giratoriu și urmați {exit_number} ieșire',
                  name:
                    'Intrați în sensul giratoriu și urmați {exit_number} ieșire pe {way_name}',
                  destination:
                    'Intrați în sensul giratoriu și urmați {exit_number} ieșire spre {destination}',
                },
                name_exit: {
                  default:
                    'Intrați în {rotary_name} și urmați {exit_number} ieșire',
                  name:
                    'Intrați în {rotary_name} și urmați {exit_number} ieșire pe {way_name}',
                  destination:
                    'Intrați în  {rotary_name} și urmați {exit_number} ieșire spre {destination}',
                },
              },
            },
            roundabout: {
      ...
      function (_dereq_, module, exports) {
        module.exports = {
          ...
          v5: {
            ...
            phrase: {
              'two linked by distance':
                '{instruction_one}, затем через {distance} {instruction_two}',
            ...
            arrive: {
              ...
              left: {
                ...
                upcoming:
                  'Вы прибудете в {nth} пункт назначения, он будет слева',
                short: 'Вы прибыли',
                'short-upcoming': 'Вы скоро прибудете',
                named:
                  'Вы прибыли в пункт назначения, {waypoint_name}, он находится слева',
              },
              right: {
                default:
                  'Вы прибыли в {nth} пункт назначения, он находится справа',
                upcoming:
                  'Вы прибудете в {nth} пункт назначения, он будет справа',
                short: 'Вы прибыли',
                'short-upcoming': 'Вы скоро прибудете',
                named:
                  'Вы прибыли в пункт назначения, {waypoint_name}, он находится справа',
              },
              'sharp left': {
                default:
                  'Вы прибыли в {nth} пункт назначения, он находится слева сзади',
                upcoming:
                  'Вы прибудете в {nth} пункт назначения, он будет слева сзади',
                short: 'Вы прибыли',
                'short-upcoming': 'Вы скоро прибудете',
                named:
                  'Вы прибыли в пункт назначения, {waypoint_name}, он находится слева сзади',
              },
              'sharp right': {
                default:
                  'Вы прибыли в {nth} пункт назначения, он находится справа сзади',
                upcoming:
                  'Вы прибудете в {nth} пункт назначения, он будет справа сзади',
                short: 'Вы прибыли',
                'short-upcoming': 'Вы скоро прибудете',
                named:
                  'Вы прибыли в пункт назначения, {waypoint_name}, он находится справа сзади',
              },
              'slight right': {
                default:
                  'Вы прибыли в {nth} пункт назначения, он находится справа впереди',
                upcoming:
                  'Вы прибудете в {nth} пункт назначения, он будет справа впереди',
                short: 'Вы прибыли',
                'short-upcoming': 'Вы скоро прибудете',
                named:
                  'Вы прибыли в пункт назначения, {waypoint_name}, он находится справа впереди',
              },
              'slight left': {
                default:
                  'Вы прибыли в {nth} пункт назначения, он находится слева впереди',
                upcoming:
                  'Вы прибудете в {nth} пункт назначения, он будет слева впереди',
                short: 'Вы прибыли',
                'short-upcoming': 'Вы скоро прибудете',
                named:
                  'Вы прибыли в пункт назначения, {waypoint_name}, он находится слева впереди',
              },
              straight: {
                default:
                  'Вы прибыли в {nth} пункт назначения, он находится перед Вами',
                upcoming:
                  'Вы прибудете в {nth} пункт назначения, он будет перед Вами',
                short: 'Вы прибыли',
                'short-upcoming': 'Вы скоро прибудете',
                named:
                  'Вы прибыли в пункт назначения, {waypoint_name}, он находится перед Вами',
              },
            },
            continue: {
              default: {
                ...
                destination:
                  'Двигайтесь {modifier} в направлении {destination}',
            ...
            depart: {
              default: {
                ...
                name:
                  'Двигайтесь в {direction} направлении по {way_name:dative}',
                namedistance:
                  'Двигайтесь {distance} в {direction} направлении по {way_name:dative}',
              },
            },
            'end of road': {
              default: {
              ...
              uturn: {
                ...
                destination:
                  'В конце дороги развернитесь в направлении {destination}',
              },
            },
            fork: {
              default: {
                ...
                name:
                  'На развилке двигайтесь {modifier} на {way_name:accusative}',
                destination:
                  'На развилке двигайтесь {modifier} в направлении {destination}',
              },
              'slight left': {
                default: 'На развилке держитесь левее',
                name: 'На развилке держитесь левее на {way_name:accusative}',
                destination:
                  'На развилке держитесь левее и продолжите движение в направлении {destination}',
              },
              'slight right': {
                default: 'На развилке держитесь правее',
                name: 'На развилке держитесь правее на {way_name:accusative}',
                destination:
                  'На развилке держитесь правее и продолжите движение в направлении {destination}',
              },
              'sharp left': {
                default: 'На развилке резко поверните налево',
                name: 'Резко поверните налево на {way_name:accusative}',
                destination:
                  'Резко поверните налево и продолжите движение в направлении {destination}',
              },
              'sharp right': {
                default: 'На развилке резко поверните направо',
                name: 'Резко поверните направо на {way_name:accusative}',
                destination:
                  'Резко поверните направо и продолжите движение в направлении {destination}',
              },
              uturn: {
                default: 'На развилке развернитесь',
                name: 'На развилке развернитесь на {way_name:prepositional}',
                destination:
                  'На развилке развернитесь и продолжите движение в направлении {destination}',
              },
            },
            merge: {
              default: {
                ...
                destination:
                  'Перестройтесь {modifier} в направлении {destination}',
              },
              straight: {
                default: 'Двигайтесь прямо',
                name: 'Продолжите движение по {way_name:dative}',
              ...
              'sharp left': {
                ...
                destination:
                  'Перестраивайтесь левее в направлении {destination}',
              },
              'sharp right': {
                default: 'Перестраивайтесь правее',
                name: 'Перестраивайтесь правее на {way_name:accusative}',
                destination:
                  'Перестраивайтесь правее в направлении {destination}',
              },
              uturn: {
                default: 'Развернитесь',
            ...
            'new name': {
              ...
              uturn: {
                ...
                name: 'Развернитесь на {way_name:prepositional}',
                destination:
                  'Развернитесь и продолжите движение в направлении {destination}',
              },
            },
            notification: {
              default: {
            ...
            rotary: {
              default: {
                default: {
                  ...
                  name:
                    'На круговой развязке сверните на {way_name:accusative}',
                  destination:
                    'На круговой развязке сверните в направлении {destination}',
                },
                name: {
                  default: 'Продолжите движение по {rotary_name:dative}',
                  name:
                    'На {rotary_name:prepositional} сверните на {way_name:accusative}',
                  destination:
                    'На {rotary_name:prepositional} сверните в направлении {destination}',
                },
                exit: {
                  default:
                    'На круговой развязке сверните на {exit_number} съезд',
                  name:
                    'На круговой развязке сверните на {exit_number} съезд на {way_name:accusative}',
                  destination:
                    'На круговой развязке сверните на {exit_number} съезд в направлении {destination}',
                },
                name_exit: {
                  default:
                    'На {rotary_name:prepositional} сверните на {exit_number} съезд',
                  name:
                    'На {rotary_name:prepositional} сверните на {exit_number} съезд на {way_name:accusative}',
                  destination:
                    'На {rotary_name:prepositional} сверните на {exit_number} съезд в направлении {destination}',
                },
              },
            },
            roundabout: {
            ...
            'exit roundabout': {
              default: {
                ...
                destination:
                  'Сверните с круговой развязки в направлении {destination}',
              },
            },
            'exit rotary': {
              default: {
      ...
      function (_dereq_, module, exports) {
        module.exports = {
          ...
          v5: {
            ...
            phrase: {
              'two linked by distance':
                '{instruction_one}, sedan efter {distance}, {instruction_two}',
            ...
            arrive: {
              ...
              left: {
                ...
                upcoming:
                  'Du är snart framme vid din {nth} destination, till vänster',
                short: 'Du är framme',
                'short-upcoming': 'Du är snart framme',
              ...
              right: {
                ...
                upcoming:
                  'Du är snart framme vid din {nth} destination, till höger',
                short: 'Du är framme',
                'short-upcoming': 'Du är snart framme',
              ...
              straight: {
                ...
                upcoming:
                  'Du är snart framme vid din {nth} destination, rakt fram',
                short: 'Du är framme',
                'short-upcoming': 'Du är snart framme',
            ...
            'end of road': {
              ...
              uturn: {
                ...
                destination:
                  'Gör en U-sväng mot {destination} i slutet av vägen',
              },
            },
            fork: {
              default: {
            ...
            'off ramp': {
              ...
              left: {
                ...
                exit_destination:
                  'Ta avfart {exit} till vänster mot {destination}',
              },
              right: {
                ...
                exit_destination:
                  'Ta avfart {exit} till höger mot {destination}',
              },
              'sharp left': {
                default: 'Ta avfarten till vänster',
                name: 'Ta avfarten till vänster in på {way_name}',
            ...
            rotary: {
              default: {
                ...
                exit: {
                  ...
                  name:
                    'I rondellen, ta {exit_number} avfarten in på {way_name}',
                  destination:
                    'I rondellen, ta {exit_number} avfarten mot {destination}',
                },
                name_exit: {
                  default: 'I {rotary_name}, ta {exit_number} avfarten',
                  name:
                    'I {rotary_name}, ta {exit_number}  avfarten in på {way_name}',
                  destination:
                    'I {rotary_name}, ta {exit_number} avfarten mot {destination}',
                },
              },
            },
            roundabout: {
      ...
      function (_dereq_, module, exports) {
        module.exports = {
          ...
          v5: {
            ...
            phrase: {
              'two linked by distance':
                '{instruction_one} ve {distance} sonra {instruction_two}',
            ...
            continue: {
              ...
              'sharp left': {
                ...
                destination:
                  '{destination} istikametinde sola keskin dönüş yap',
              },
              'sharp right': {
                default: 'Sağa keskin dönüş yap',
                name: '{way_name} üzerinde kalmak için sağa keskin dönüş yap',
                destination:
                  '{destination} istikametinde sağa keskin dönüş yap',
              },
              'slight left': {
            ...
            'end of road': {
              ...
              uturn: {
                ...
                destination:
                  'Yolun sonunda {destination} istikametinde bir U-dönüşü yap',
              },
            },
            fork: {
              default: {
                ...
                name:
                  '{way_name} üzerindeki yol ayrımında {modifier} yönde kal',
                destination:
                  '{destination} istikametindeki yol ayrımında {modifier} yönde kal',
              },
              'slight left': {
                default: 'Çatalın solundan devam edin',
                name: 'Çatalın solundan {way_name} yoluna doğru ',
                destination:
                  '{destination} istikametindeki yol ayrımında solda kal',
              },
              'slight right': {
                default: 'Çatalın sağından devam edin',
                name: '{way_name} üzerindeki yol ayrımında sağda kal',
                destination:
                  '{destination} istikametindeki yol ayrımında sağda kal',
              },
              'sharp left': {
            ...
            'new name': {
              default: {
                ...
                destination:
                  '{destination} istikametinde {modifier} yönde devam et',
              },
              straight: {
            ...
            'off ramp': {
              default: {
                ...
                destination:
                  '{destination} istikametine giden bağlantı yoluna geç',
                exit: '{exit} çıkış yoluna geç',
                exit_destination:
                  '{destination} istikametindeki {exit} çıkış yoluna geç',
              },
              left: {
                default: 'Soldaki bağlantı yoluna geç',
                name: '{way_name} üzerindeki sol bağlantı yoluna geç',
                destination:
                  '{destination} istikametine giden sol bağlantı yoluna geç',
                exit: 'Soldaki {exit} çıkış yoluna geç',
                exit_destination:
                  '{destination} istikametindeki {exit} sol çıkış yoluna geç',
              },
              right: {
                default: 'Sağdaki bağlantı yoluna geç',
                name: '{way_name} üzerindeki sağ bağlantı yoluna geç',
                destination:
                  '{destination} istikametine giden sağ bağlantı yoluna geç',
                exit: 'Sağdaki {exit} çıkış yoluna geç',
                exit_destination:
                  '{destination} istikametindeki {exit} sağ çıkış yoluna geç',
              },
              'sharp left': {
                default: 'Soldaki bağlantı yoluna geç',
                name: '{way_name} üzerindeki sol bağlantı yoluna geç',
            ...
            rotary: {
              default: {
                default: {
                  ...
                  destination:
                    'Dönel kavşağa gir ve {destination} istikametinde çık',
                },
                name: {
                  default: '{rotary_name} dönel kavşağa gir',
                  name:
                    '{rotary_name} dönel kavşağa gir ve {way_name} üzerinde çık',
                  destination:
                    '{rotary_name} dönel kavşağa gir ve {destination} istikametinde çık',
                },
                exit: {
                  default:
                    'Dönel kavşağa gir ve {exit_number} numaralı çıkışa gir',
                  name:
                    'Dönel kavşağa gir ve {way_name} üzerindeki {exit_number} numaralı çıkışa gir',
                  destination:
                    'Dönel kavşağa gir ve {destination} istikametindeki {exit_number} numaralı çıkışa gir',
                },
                name_exit: {
                  default:
                    '{rotary_name} dönel kavşağa gir ve {exit_number} numaralı çıkışa gir',
                  name:
                    '{rotary_name} dönel kavşağa gir ve {way_name} üzerindeki {exit_number} numaralı çıkışa gir',
                  destination:
                    '{rotary_name} dönel kavşağa gir ve {destination} istikametindeki {exit_number} numaralı çıkışa gir',
                },
              },
            },
            roundabout: {
              default: {
                exit: {
                  default:
                    'Göbekli kavşağa gir ve {exit_number} numaralı çıkışa gir',
                  name:
                    'Göbekli kavşağa gir ve {way_name} üzerindeki {exit_number} numaralı çıkışa gir',
                  destination:
                    'Göbekli kavşağa gir ve {destination} istikametindeki {exit_number} numaralı çıkışa gir',
                },
                default: {
                  default: 'Göbekli kavşağa gir',
                  name: 'Göbekli kavşağa gir ve {way_name} üzerinde çık',
                  destination:
                    'Göbekli kavşağa gir ve {destination} istikametinde çık',
                },
              },
            },
            'roundabout turn': {
      ...
      function (_dereq_, module, exports) {
        module.exports = {
          ...
          v5: {
            ...
            phrase: {
              'two linked by distance':
                '{instruction_one}, потім, через {distance}, {instruction_two}',
            ...
            arrive: {
              ...
              left: {
                default:
                  'Ви прибули у ваш {nth} пункт призначення, він – ліворуч',
                upcoming:
                  'Ви наближаєтесь до вашого {nth} місця призначення, ліворуч',
                short: 'Ви прибули',
                'short-upcoming': 'Ви прибудете',
              ...
              right: {
                default:
                  'Ви прибули у ваш {nth} пункт призначення, він – праворуч',
                upcoming:
                  'Ви наближаєтесь до вашого {nth} місця призначення, праворуч',
                short: 'Ви прибули',
                'short-upcoming': 'Ви прибудете',
              ...
              straight: {
                default:
                  'Ви прибули у ваш {nth} пункт призначення, він – прямо перед вами',
                upcoming:
                  'Ви наближаєтесь до вашого {nth} місця призначення, прямо перед вами',
                short: 'Ви прибули',
                'short-upcoming': 'Ви прибудете',
            ...
            depart: {
              default: {
                ...
                namedistance:
                  'Прямуйте на {direction} по {way_name} {distance}',
              },
            },
            'end of road': {
              default: {
              ...
              uturn: {
                ...
                destination:
                  'Здійсніть розворот у напрямку {destination} в кінці дороги',
              },
            },
            fork: {
              default: {
            ...
            merge: {
              default: {
                ...
                destination:
                  'Приєднайтеся до потоку {modifier} у напрямку {destination}',
              },
              straight: {
              ...
              'slight left': {
                ...
                destination:
                  'Приєднайтеся до потоку ліворуч у напрямку {destination}',
              },
              'slight right': {
                default: 'Приєднайтеся до потоку праворуч',
                name: 'Приєднайтеся до потоку праворуч на {way_name}',
                destination:
                  'Приєднайтеся до потоку праворуч у напрямку {destination}',
              },
              'sharp left': {
                default: 'Приєднайтеся до потоку ліворуч',
                name: 'Приєднайтеся до потоку ліворуч на {way_name}',
            ...
            'new name': {
              ...
              'slight left': {
                ...
                destination:
                  'Рухайтесь плавно ліворуч у напрямку {destination}',
              },
              'slight right': {
                default: 'Рухайтесь плавно праворуч',
                name: 'Рухайтесь плавно праворуч на {way_name}',
                destination:
                  'Рухайтесь плавно праворуч у напрямку {destination}',
              },
              uturn: {
                default: 'Здійсніть розворот',
                name: 'Здійсніть розворот на {way_name}',
            ...
            'off ramp': {
              default: {
                ...
                exit_destination:
                  "Оберіть з'їзд {exit} у напрямку {destination}",
              },
              left: {
                default: 'Рухайтесь на зʼїзд ліворуч',
                name: 'Рухайтесь на зʼїзд ліворуч на {way_name}',
                destination:
                  'Рухайтесь на зʼїзд ліворуч у напрямку {destination}',
                exit: "Оберіть з'їзд {exit} ліворуч",
                exit_destination:
                  "Оберіть з'їзд {exit} ліворуч у напрямку {destination}",
              },
              right: {
                default: 'Рухайтесь на зʼїзд праворуч',
                name: 'Рухайтесь на зʼїзд праворуч на {way_name}',
                destination:
                  'Рухайтесь на зʼїзд праворуч у напрямку {destination}',
                exit: "Оберіть з'їзд {exit} праворуч",
                exit_destination:
                  "Оберіть з'їзд {exit} праворуч у напрямку {destination}",
              },
              'sharp left': {
                default: 'Рухайтесь на зʼїзд ліворуч',
                name: 'Рухайтесь на зʼїзд ліворуч на {way_name}',
            ...
            'on ramp': {
              ...
              left: {
                ...
                destination:
                  'Рухайтесь на вʼїзд ліворуч у напрямку {destination}',
              },
              right: {
                default: 'Рухайтесь на вʼїзд праворуч',
                name: 'Рухайтесь на вʼїзд праворуч на {way_name}',
                destination:
                  'Рухайтесь на вʼїзд праворуч у напрямку {destination}',
              },
              'sharp left': {
                default: 'Рухайтесь на вʼїзд ліворуч',
                name: 'Рухайтесь на вʼїзд ліворуч на {way_name}',
            ...
            rotary: {
              default: {
                ...
                name: {
                  ...
                  destination:
                    'Рухайтесь по {rotary_name} та поверніть в напрямку {destination}',
                },
                exit: {
                  default:
                    "Рухайтесь по колу та повереніть у {exit_number} з'їзд",
                  name:
                    "Рухайтесь по колу та поверніть у {exit_number} з'їзд на {way_name}",
                  destination:
                    "Рухайтесь по колу та поверніть у {exit_number} з'їзд у напрямку {destination}",
                },
                name_exit: {
                  default:
                    "Рухайтесь по {rotary_name} та поверніть у {exit_number} з'їзд",
                  name:
                    "Рухайтесь по {rotary_name} та поверніть у {exit_number} з'їзд на {way_name}",
                  destination:
                    "Рухайтесь по {rotary_name} та поверніть у {exit_number} з'їзд в напрямку {destination}",
                },
              },
            },
            roundabout: {
      ...
      function (_dereq_, module, exports) {
        module.exports = {
          ...
          v5: {
            ...
            phrase: {
              'two linked by distance':
                '{instruction_one}, rồi {distance} nữa thì {instruction_two}',
            ...
            depart: {
              default: {
                ...
                namedistance:
                  'Đi về hướng {direction} trên {way_name} cho {distance}',
              },
            },
            'end of road': {
              default: {
            ...
            'off ramp': {
              ...
              left: {
                ...
                exit_destination:
                  'Đi theo lối ra {exit} bên trái về {destination}',
              },
              right: {
                ...
                exit_destination:
                  'Đi theo lối ra {exit} bên phải về {destination}',
              },
              'sharp left': {
                default: 'Đi đường nhánh bên trái',
                name: 'Đi đường nhánh {way_name} bên trái',
            ...
            rotary: {
              default: {
                ...
                exit: {
                  ...
                  name:
                    'Đi vào bùng binh và ra tại đường {exit_number} tức {way_name}',
                  destination:
                    'Đi vào bùng binh và ra tại đường {exit_number} về {destination}',
                },
                name_exit: {
                  default: 'Đi vào {rotary_name} và ra tại đường {exit_number}',
                  name:
                    'Đi vào {rotary_name} và ra tại đường {exit_number} tức {way_name}',
                  destination:
                    'Đi vào {rotary_name} và ra tại đường {exit_number} về {destination}',
                },
              },
            },
            roundabout: {
      ...
      function (_dereq_, module, exports) {
        module.exports = {
          ...
          v5: {
            ...
            phrase: {
              'two linked by distance':
                '{instruction_one}，{distance}后{instruction_two}',
            ...
            depart: {
              default: {
                ...
                namedistance:
                  '出发向{direction}，在{way_name}上继续行驶{distance}',
              },
            },
            'end of road': {
              default: {
            ...
            rotary: {
              default: {
                ...
                exit: {
                  ...
                  destination:
                    '进入环岛后从{exit_number}出口驶出，前往{destination}',
                },
                name_exit: {
                  default: '进入{rotary_name}环岛后从{exit_number}出口驶出',
                  name:
                    '进入{rotary_name}环岛后从{exit_number}出口驶出，上{way_name}',
                  destination:
                    '进入{rotary_name}环岛后从{exit_number}出口驶出，前往{destination}',
                },
              },
            },
            roundabout: {
    ...
    49: [
          ...
          (function () {
            ...
            module.exports = Itinerary.extend({
              ...
              initialize: function (options) {
                ...
                this._plan =
                  this.options.plan ||
                  new Plan(this.options.waypoints, options);
              ...
              onRemove: function (map) {
                ...
                if (this._alternatives && this._alternatives.length > 0) {
                  for (
                    var i = 0, len = this._alternatives.length;
                    i < len;
                    i++
                  ) {
              ...
              spliceWaypoints: function () {
                var removed = this._plan.spliceWaypoints.apply(
                  this._plan,
                  arguments
                );
                return removed;
              ...
              _updateLineCallback: function (err, routes) {
                if (!err) {
                  routes = routes.slice();
                  var selected = routes.splice(
                    this._selectedRoute.routesIndex,
                    1
                  )[0];
                  this._updateLines({
                    route: selected,
              ...
              route: function (options) {
                ...
                if (this._plan.isReady()) {
                  ...
                  wps =
                    (options && options.waypoints) || this._plan.getWaypoints();
      ...
      { './itinerary': 55, './line': 56, './osrm-v1': 59, './plan': 60 },
    ],
    50: [
      function (_dereq_, module, exports) {
        (function (global) {
              ...
              options: {
                ...
                formatMessage: function (error) {
                  if (error.status < 0) {
                    ...
                    return (
                      'The route could not be calculated. ' + error.message
                    );
                  }
                },
              },
            ...
            module.exports = L.Class.extend({
              ...
              formatDistance: function (d /* Number (meters) */, sensitivity) {
                var un =
                    ...
                    this._localization.localize('units'),
                ...
                if (instr.text === undefined) {
                  return this.capitalize(
                    L.Util.template(
                      ...
                      L.extend({}, instr, {
                        exitStr: instr.exit
                          ? this._localization.localize('formatOrder')(
                              instr.exit
                            )
                          : '',
                        dir: this._localization.localize([
                          'directions',
                          instr.direction,
                        ]),
                        modifier: this._localization.localize([
                          'directions',
                          instr.modifier,
                        ]),
                      })
    ...
    52: [
      ...
      { './autocomplete': 48, './localization': 57 },
    ],
    53: [
      function (_dereq_, module, exports) {
        (function (global) {
    ...
    55: [
          ...
          (function () {
            ...
            module.exports = L.Control.extend({
              ...
              initialize: function (options) {
                L.setOptions(this, options);
                this._formatter =
                  this.options.formatter || new Formatter(this.options);
              ...
              onAdd: function (map) {
                ...
                L.DomEvent.addListener(this._container, 'mousewheel', function (
                  e
                ) {
      ...
      { './formatter': 51, './itinerary-builder': 54 },
    ],
    56: [
      function (_dereq_, module, exports) {
        (function (global) {
          (function () {
            ...
            module.exports = L.LayerGroup.extend({
              ...
              _onLineTouched: function (e) {
                var afterIndex = this._findNearestWpBefore(
...
*/
        ...
        (function () {
          ...
          var Localization = L.Class.extend({
            initialize: function (langs) {
              this._langs = L.Util.isArray(langs)
                ? langs.slice()
                : [langs, 'en'];
          ...
          module.exports = L.extend(Localization, {
            ...
            de: {
              ...
              instructions: {
                ...
                OnRamp: [
                  'Fahren Sie {modifier} auf die Auffahrt',
                  ' auf {road}',
                ],
                OffRamp: ['Nehmen Sie die Ausfahrt {modifier}', ' auf {road}'],
                EndOfRoad: [
                  'Fahren Sie {modifier} am Ende der Straße',
                  ' auf {road}',
                ],
                Onto: 'auf {road}',
              },
            ...
            ca: {
              ...
              instructions: {
                ...
                Roundabout: [
                  'Agafar {exitStr} sortida a la rotonda',
                  ' a {road}',
                ],
            ...
            ru: {
              ...
              instructions: {
                ...
                EndOfRoad: [
                  'Поверните {modifier} в конце дороги',
                  ' на {road}',
                ],
                Onto: 'на {road}',
              },
            ...
            pl: {
              ...
              instructions: {
                ...
                Roundabout: [
                  'Wyjedź {exitStr} zjazdem na rondzie',
                  ' na {road}',
                ],
            ...
            module.exports = L.Class.extend({
                    ...
                    if (!timedOut) {
                      if (!err) {
                        try {
                          ...
                          error.status = -2;
                          error.message =
                            'Error parsing OSRM response: ' + ex.toString();
                        }
                      } else {
                        error.message =
                          'HTTP request failed: ' +
                          err.type +
                          (err.target && err.target.status
                            ? ' HTTP ' +
                              err.target.status +
                              ': ' +
              ...
              _convertRoute: function (responseRoute) {
                ...
                for (i = 0; i < legCount; i++) {
                  ...
                  legNames.push(
                    leg.summary &&
                      leg.summary.charAt(0).toUpperCase() +
                  ...
                  for (j = 0; j < leg.steps.length; j++) {
                    ...
                    type = this._maneuverToInstructionType(
                      step.maneuver,
                      i === legCount - 1
                    );
                    ...
                    if (type) {
                      ...
                      result.instructions.push({
                        ...
                        time: step.duration,
                        road: step.name,
                        direction: this._bearingToDirection(
                          step.maneuver.bearing_after
                        ),
                ...
                if (!hasSteps) {
                  result.coordinates = this._decodePolyline(
              ...
              buildRouteUrl: function (waypoints, options) {
                ...
                for (var i = 0; i < waypoints.length; i++) {
                  ...
                  hints.push(
                    this._hints.locations[this._locationKey(latLng)] || ''
                  );
                }
                ...
                return (
                  ...
                  (options.allowUTurns
                    ? '&continue_straight=' + !options.allowUTurns
                    : '')
                );
              },
    ...
    60: [
          ...
          (function () {
            ...
            module.exports = (L.Layer || L.Class).extend({
              ...
              createGeocoders: function () {
                var container = L.DomUtil.create(
                    ...
                    'leaflet-routing-geocoders ' +
                      this.options.geocodersClassName
                  ),
                ...
                if (this.options.addWaypoints) {
                  addWpBtn = L.DomUtil.create(
                    ...
                    'leaflet-routing-add-waypoint ' +
                      this.options.addButtonClassName,
                    container
                  );
              ...
              _createGeocoder: function (i) {
                var geocoder = this.options.createGeocoderElement(
                  this._waypoints[i],
                  i,
              ...
              _dragNewWaypoint: function (newWpIndex, initialLatLng) {
                var wp = new Waypoint(initialLatLng),
                  ...
                  marker = this.options.createMarker(
                    newWpIndex,
                    wp,
      ...
      { './geocoder-element': 52, './waypoint': 61 },
    ],
    61: [
      function (_dereq_, module, exports) {
        (function (global) {
